 ...
 * ## 一页五条，但**末页可能只有三条**
 *
 * 术语库按每页五条切（国内 83 条 = 17 页，末页 3 条；国际 60 条 = 12 页，正好整）。
 * 用户对末页拍板的是"照旧五等分，缺的那两行留空、不可填也不计分"，
 * 因此两栏一律画 **五行**（`termRowsOf` 把缺的补成 `null`），
...
export function TermResults({
  ...
  /* 末页不满五条时同样补空行，好与原文栏的横线对齐（与 TermRows 同一份口径） */
